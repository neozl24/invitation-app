...
export const Footer = () => {
  return (
    <div className='w-full h-16 sm:h-24 flex flex-col justify-center items-center border-t border-solid border-t-neutral-300'>
      <Line className='mb-1'>
        Made with
...
const Line = ({
  ...
  const baseClassName = 'flex items-center text-xs sm:text-sm italic text-neutral-400'
  return (
