...
export const Header = () => {
  return (
    <div className='w-full h-16 sm:h-24 flex justify-center border-b border-solid border-b-neutral-300'>
      <div className='flex h-full items-center justify-center w-full lg:w-[1000px] lg:justify-start'>
        <img src={broccoliLogo} width='32' alt="Broccoli logo" className='mr-4 hidden sm:inline' />
